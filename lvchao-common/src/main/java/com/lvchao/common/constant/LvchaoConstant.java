package com.lvchao.common.constant;
...
public class LvchaoConstant {
     ...
     * 验证码 key前缀
     */
    public static final String CODE_PREFIX = "lvchao.captcha.";

    /**
     * 短信验证码 key前缀
     */
    public static final String SMS_CODE_PREFIX = "lvchao.sms.";


    /**
     * 异步线程池名称
     */
    public static final String ASYNC_POOL = "LvchaoAsyncThreadPool";
