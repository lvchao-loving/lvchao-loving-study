...
public class ValidateUtils {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println(validPhoneNum("0","14711111111"));
...
//		p1 = Pattern.compile("^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1})|(17[0-9]{1}))+\\d{8})?$");
		p1 = Pattern.compile("^(((13[0-9]{1})|(14[0-9]{1})|(15[0-9]{1})|(16[0-9]{1})|(18[0-9]{1})|(17[0-9]{1})|(19[0-9]{1}))+\\d{8})?$");// 新增14、16、19开头的手机号
...
//			System.out.println(phoneNum.length());
		...
		}else if(checkType == null || "2".equals(checkType)){
